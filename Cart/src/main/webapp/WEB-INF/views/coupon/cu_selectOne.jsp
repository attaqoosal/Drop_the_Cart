...
<body>
	...
	<form:form modelAttribute="vo" action="cu_updateOK.do" method="post"
		enctype="multipart/form-data">
		<input type="hidden" name="num" value="${vo2.num}"/>num: ${vo2.num}<br><br>
		쿠폰명: &nbsp;<input type="text" name="name" value="${vo2.name}" />
		<br><br>
		할인가격: &nbsp;<input type="text" name="price" value="${vo2.price}" />
		<br><br>
